SELECT pl.id 'PROCESS ID', trx.trx_started,esh.event_name 'EVENT NAME',esh.sql_text 'SQL'
...
INNER JOIN performance_schema.events_statements_history esh ON esh.thread_id = th.thread_id
